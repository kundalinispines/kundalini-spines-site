...
function buildEmail(opts) {
  ...
  const text = [
    ...
    '',
    'Two files are waiting: MP3 (about 271 MB) for listening, and WAV masters',
  ...
  const html = [
    ...
    '<p style="margin:0 0 20px;">Two files are waiting: <strong>MP3</strong> (about 271&nbsp;MB) for listening, and <strong>WAV masters</strong> (about 1.4&nbsp;GB). Both are yours &mdash; they are the same album, and the <strong>deluxe digital booklet</strong> is packed inside each one.</p>',
