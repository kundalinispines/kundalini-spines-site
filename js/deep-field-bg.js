...
(function () {
  ...
  /* Straight there, no playback. Used by the skip-ahead and by every backward
     landing (see GOING BACK IS A CUT). */
  ...
  /* GOING BACK IS A CUT (owner's call, Sept 2 2026).
     ...
     A DISSOLVE WAS BUILT AND RIPPED OUT THE SAME DAY (Sept 2 2026). Offered
     with the cut and declined that morning; by evening the owner had watched
     the sky fade on Music-to-About and asked for the same where two bare
     frames meet. Build 20 did it with a canvas copy of the outgoing frame laid
     over the clip and faded off the incoming one (commit ea29d89). Watched on
     the page, twice, it read as "a flashing, annoying, blinding effect" -
     first on Merch-to-Music under the rising nebula, then on the bare-frame
     legs with that one excluded - and the owner said to rip it out. So going
     back is a hard cut, full stop. The legs that touch the sky (Music,
     Stay Connected, the Foot) still fade, because the nebula dissolving over
     a settled frame IS the fade the owner liked; that lives in arrive() and
     the sky ramps, not in any cut. Do not offer the dissolve a third time.
