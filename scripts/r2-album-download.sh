...
say "Three of them. Set Type BEFORE pasting the value."
note "Also renamed by Cloudflare — this was 'Environment variables' when"
note "this wizard was written, and the secret toggle was labelled Encrypt."
note "Secrets and plain variables now share one screen and one dialog, and"
note "a Type dropdown reading Text or Secret is what separates them."
printf '\n'
step "1.  Type: Secret   STRIPE_SECRET_KEY = your LIVE key (sk_live_...)"
say "        From https://dashboard.stripe.com/apikeys — live mode,"
say "        'Reveal live key'."
printf '\n'
step "2.  Type: Secret   DOWNLOAD_SIGNING_KEY = the string from stage 7"
printf '\n'
step "3.  Type: Text     PRICE_ID_DIGITAL = $PRICE_ID_DIGITAL"
printf '\n'
...
step "Click 'Save'."
printf '\n'
warn "Secret means you cannot read the value back afterwards. That is the"
